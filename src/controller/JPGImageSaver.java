...
/**
 * A class which implements the IImagesaver interface to save JPG
 * images.
 */
public class JPGImageSaver implements IImageSaver {
  ...
  /**
   * Constructor for the JPGImageSaver.
   *     @param pathToSave The path to save the image at.
   *     @param image The image to save.
   *     @param out A printstream.
   */
  public JPGImageSaver(String pathToSave, IImageState image, PrintStream out) {
    this.pathToSave = Objects.requireNonNull(pathToSave);
    this.image = Objects.requireNonNull(image);
  }

  /**
   * Runs the JPGImageSaver.
   */
  @Override
  public void run() {
    try {
